...
ns = Namespace('eventbookings', description='Event Bookings')
...
@ns.route('/eventbooking')
class GetEventBookingDetails(Resource):
    ...
    def get(self):
        ...
        result, error_msg, ret_code = db.get_eventbooking_info(event_date, event_id)
